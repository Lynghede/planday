...
var TileUI = React.memo(function tileui(_a) {
  var renderTile = _a.renderTile,
    props = __rest(_a, ["renderTile"]);
...
var dataWithKeys = function (data, dataWithKeys) {
  return data.map(function (item) {
    var existingItem = dataWithKeys.find(function (k) {
      return k.item === item;
    });
...
var TilesContainer = function (props) {
  ...
  var columns = isTilesContainerColsProps(props)
    ...
    : 4;
  var onReorderTiles = props.onReorderTiles,
    _b = props.ratio,
    ratio = _b === void 0 ? 1 : _b,
    forceTileHeight = props.forceTileHeight,
    propsData = props.data,
    acceptsDrop = props.acceptsDrop,
    onTileDrop = props.onTileDrop,
    _c = props.tileSize,
    tileSize = _c === void 0 ? defaultTileSize : _c,
    renderTile = props.renderTile,
    renderInsertIndicator = props.renderInsertIndicator,
    _d = props.activeBorderSize,
    activeBorderSize = _d === void 0 ? 24 : _d,
    disabled = props.disabled,
    _e = props.strategy,
    strategy = _e === void 0 ? "move" : _e;
    ...
    function () {
      ...
      data.forEach(function (_a) {
        var tile = _a.item,
          key = _a.key;
        return tiles.push(
          __assign(__assign({ key: key }, tileSize(tile)), { data: tile })
        );
      });
      return tiles;
    },
  ...
  var _g = useTileTable({
      ...
      changeTilesOrder: function (tiles) {
        var newData = tiles.map(function (tile) {
          return tile.data;
        });
    ...
    bind = _g.bind,
    renderTileProps = _g.renderTileProps,
    tableHeight = _g.tableHeight,
    insertIndicatorPosition = _g.insertIndicatorPosition;
  var insertIndicator = useMemo(
    function () {
      if (!insertIndicatorPosition || !renderInsertIndicator) {
        return null;
      }
      var x = insertIndicatorPosition.x,
        y = insertIndicatorPosition.y;
    ...
    function () {
      return renderTileProps.map(function (_a) {
        ...
        return React.createElement(
          ...
          React.createElement(
            TileUI,
            __assign({}, props, { renderTile: renderTile })
          )
        );
      });
    },
